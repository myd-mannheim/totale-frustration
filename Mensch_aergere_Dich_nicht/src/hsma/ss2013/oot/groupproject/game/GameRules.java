...
public class GameRules {
    ...
    public ArrayList<Move> possibleMoves(int diceRoll, Player player, Board board) {
    ...
    private boolean isBarrier(int diceRoll, Player player, Board board, Token currToken) {
    ...
    private boolean isThrowable(int diceRoll, Player player, Board board, Token currToken) {
    ...
    private boolean isBarrierPossible(int diceRoll, Player player, Board board, Token currToken) {
	int futurePos = diceRoll + currToken.getPosition();
	if (futurePos > 39) {
	    futurePos = futurePos % 39;
	}
    ...
    private boolean isFinishPossible(int diceRoll, Player player, Board board, Token currToken) {
