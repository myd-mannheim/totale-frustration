 ...
 */
public class AI {
    //die Reihenfolge spiegelt die Priorisierung wieder, Indexplatz [0] heißt hohe Prio
	...
	// Sortiere {@code ArrayList<Moves>} nach Token unter Berücksichtigung der Token-ID)
    ...
    /**
     * NOT USED ATM
     * Methode für die Auswahl des besten Zugs 
     * 
     * @param rating
     * @return
     */
    ...
    /**
     * Wertet die möglichen Züge pro Token aus
     * 
     * @param moves
     * @return
     */
    ...
    /**
     * Wertet die möglichen Züge pro Token-ID aus
     * 
     * @param moves
     * @param tokenID
     * @param moveType
